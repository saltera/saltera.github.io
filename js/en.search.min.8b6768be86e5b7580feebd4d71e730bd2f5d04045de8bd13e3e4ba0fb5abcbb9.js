...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.9322d79f1631633fe10e10a8ab35c373a9d1baff7f271992e49ed1f0125facfd.js',function(){input.required=false;search();});}

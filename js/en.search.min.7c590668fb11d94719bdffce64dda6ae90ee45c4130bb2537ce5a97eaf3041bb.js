...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.bb3e697dcacbc7948fd1fd2fd9db608207966ea9db0c9cbc2ab2242940820308.js',function(){input.required=false;search();});}

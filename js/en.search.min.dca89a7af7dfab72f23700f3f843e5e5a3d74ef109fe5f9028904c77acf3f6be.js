...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.c8162dcfd1aa4d1236826541da098a4250aa1a01408f96aedd62abdd03be095a.js',function(){input.required=false;search();});}

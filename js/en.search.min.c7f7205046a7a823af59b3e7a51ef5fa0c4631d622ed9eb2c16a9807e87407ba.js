...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.fc93a2ed59598651dcbcc06a7205b221503f6c4132c6868c74e3de349e9e3593.js',function(){input.required=false;search();});}

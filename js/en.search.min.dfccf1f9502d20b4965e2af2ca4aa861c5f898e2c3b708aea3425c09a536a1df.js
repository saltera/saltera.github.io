...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.cde2c2aa12b3ad3e9e9e70d76346fc1fb4cc1648acc00ad05d987d446b46e128.js',function(){input.required=false;search();});}

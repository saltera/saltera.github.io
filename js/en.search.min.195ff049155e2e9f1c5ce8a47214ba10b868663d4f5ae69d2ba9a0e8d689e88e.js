...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.c5fc6658532223e52b7d061bfbb4ead664cca25dcc1c3b5f9011b32047daac11.js',function(){input.required=false;search();});}

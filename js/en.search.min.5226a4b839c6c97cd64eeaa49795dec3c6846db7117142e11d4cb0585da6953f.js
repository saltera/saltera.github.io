...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/groupBy-62b30ac391.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.1b6bc77ee17677a0a696d93b332e90228b78e448a159ef591ec3ee246b8d9806.js',function(){input.required=false;search();});}
